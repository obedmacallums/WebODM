 ...
 *
 * Estos tests los lanza `FrontendUnitTest` en `tests/test_frontend.py`, para que corran con el resto de la
 * suite del plugin (`webodm.sh test backend coreplugins.road.tests`).
 */
const fs = require('fs');
